...
% dense\dense, M\v1
tic; x = gmres(B,b1); toc
norm(full(b1-B*x))

% dense\sparse, M\v1
tic; x = gmres(B,sb1); toc
norm(full(sb1-B*x))

% sparse\dense, M\v1
tic; x = gmres(sB,b1); toc
norm(full(b1-sB*x))

% sparse\sparse, M\v1
tic; x = gmres(sB,sb1); toc
norm(full(sb1-sB*x))

% dense\dense, MCol\v1
tic; x = gmres(BCol,b1); toc
norm(full(b1-BCol*x))

% dense\sparse, MCol\v1
tic; x = gmres(BCol,sb1); toc
norm(full(sb1-BCol*x))

% sparse\dense, MCol\v1
tic; x = gmres(sBCol,b1); toc
norm(full(b1-sBCol*x))

% sparse\sparse, MCol\v1
tic; x = gmres(sBCol,sb1); toc
norm(full(sb1-sBCol*x))

% dense\dense, MRow\v2
tic; x = gmres(BRow,b2); toc
norm(full(b2-BRow*x))

% dense\sparse, MRow\v2
tic; x = gmres(BRow,sb2); toc
norm(full(sb2-BRow*x))

% sparse\dense, MRow\v2
tic; x = gmres(sBRow,b2); toc
norm(full(b2-sBRow*x))

% sparse\sparse, MRow\v2
tic; x = gmres(sBRow,sb2); toc
